<x-layout>
    ...
    <div class="mt-14 md:ml-10">
        ...
        <form action="/docs" method="post" class="border-2 border-slate-500 py-10 px-5 rounded-md md:w-2/3 lg:w-1/2" enctype="multipart/form-data">
            @csrf 
            <div class="my-2">
                <label for="" class="inline-block text-xl mb-2">Title</label>
                <input type="text" name="title" class="border border-slate-500 rounded w-full py-2 px-3" placeholder="Enter a title" value="{{ old('title') }}">
            ...
            <div class="-my-2">
                ...
                <textarea name="desc" class="border border-slate-500 rounded w-full py-2 px-3" rows="5" placeholder="Descriptions here">{{ old('desc') }}</textarea>
            ...
            <div class="my-2">
                ...
                <input type="radio" id="private" name="privacy" value="private" class="ml-5">
            ...
            <div class="my-2">
                <input type="submit" value="Create" class="mt-5 bg-green-600 py-2 px-5 rounded-md text-white cursor-pointer">
            </div>
        </form>
